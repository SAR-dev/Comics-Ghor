  ...
  render () {
    ...
    return (
      ...
      <div>
        ...
        {this.state.init && <button className="bg-gray-400 w-full text-gray-700 hover:bg-gray-500 py-2" onClick={this.loadBody}>Click Here to Load Previous Contents</button>}
      </div>
      <Modal
