...
class NewDiscussion extends Component {
	...
	clickSubmit = (event) => {
		...
		this.postData.set('typeOf', 'discussion');
	...
	createPost = (series, cat, title, body, image, titleError, bodyError, imageError, uploading, loading) => (
		<form className="p-4">
			<h1 className="text-2xl tracking-wide font-semibold text-white my-3">CREATE DISCUSSION</h1>
	...
	render() {
		...
		return (
			<>
			<SeoHelmet title="Create Discussion" />
			<PrimaryLayout>
				<div
					className={
