...
class NewComic extends Component {
	...
	imageArray = () => {
		return this.state.image.map((image, i) => {
			return (
				<div className="w-full my-2 hover:opacity-50 cursor-pointer px-1" key={i}>
					<img
						className="w-full rounded object-contain bg-gray-400 px-2"
	...
	clickSubmit = (event) => {
		...
		this.postData.set('typeOf', 'comic');
		this.postData.set('summary', this.state.body.slice(0, 250));
	...
	createPost = (series, cat, title, body, image, titleError, bodyError, imageError, uploading, loading) => (
		<form className="p-4">
			<h1 className="text-2xl tracking-wide font-semibold text-white my-3">Create New Comic Chapter</h1>
            ...
            <div className="relative w-full mb-3">
				...
				<div className="border border-dashed border-gray-500 relative">
					...
					<div className="text-center p-10 absolute top-0 right-0 left-0 m-auto">
						...
						<h4 className="text-gray-600 text-xl">Click and select images to upload</h4>
					</div>
				</div>
