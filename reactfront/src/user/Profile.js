            ...
            <div className="container px-0">
                ...
                <div className="col-6 bg-white full-screen">
                    ...
                    <div className="row profile-photo">
                        ...
                        <p className="email text-muted"><i className="material-icons">email</i> <span>{ user.email } </span></p>
                        <small className="joined text-muted"><i className="material-icons">add_circle</i> <span> {`Joined ${new Date(user.created).toDateString()}`}</span></small>
