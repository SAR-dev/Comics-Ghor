    ...
    signinForm = ( email, password, loading, emailError, passwordError ) => (
        <form>
            ...
            <div className="form-group input-group">
                ...
                <input value={password} onChange={ this.handlePassword("password") }  className={ passwordError ? "form-control is-invalid" : "form-control is-valid"} placeholder="Input password" type="password" />
                <div className="valid-feedback">Looks good!</div>
            ...
            <p className="text-center">Don't have an account? <Link to="/signup" style={{textDecoration: "none"}}>Sign Up</Link> </p>
        </form>
    )
                ...
                <div className={ this.state.created ? "d-none" : "col-6 sign my-5" }>
                    <div className="card bg-light">
                        <article className="card-body mx-auto" style={{width: "80%"}}>
                            ...
                            <p className="text-center">Sign in to get the most out of Comics Ghor</p>
                            <p>
